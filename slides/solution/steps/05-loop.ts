...
async function main() {
    ...
    let interaction = await ai.interactions.create({
        ...
        input: "Read package.json to find the name of the main module file. Once you know the name of the file, read that file and summarize its contents.",
        generation_config: {
            thinking_level: 'low',
    ...
    while (interaction.status === "requires_action" && interaction.outputs) {
        const results = [];
